...
Its own 305-row self-mutation pass finishes in three to seven minutes against a suite that takes 15 seconds to run once.
...
```sh
bash test/run.sh                     # the suite, 147 units
