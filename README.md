...
Its own 122-row self-mutation pass finishes in six to seven minutes against a suite that takes 15 seconds to run once.
...
```sh
bash test/run.sh                     # the suite, 80 units
