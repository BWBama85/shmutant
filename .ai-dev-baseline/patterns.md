...
- `rewrite-loses-file-shape` `shmutant.sh` `5afd018` `PRRT_kwDOUT7q9s6h3xAb` PR #1 2026-09-13
...
- `host-shell-option-leak` `shmutant.sh` `3a1b526` `PRRT_kwDOUT7q9s6h4JCH` PR #1 2026-09-13
